...
class AllTasksFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, s: Bundle?): View {
        ...
        mListener = object : TaskListener {
            ...
            override fun onCompleteClick(id: Int) = mViewModel.complete(id)

            override fun onUndoClick(id: Int) = mViewModel.undo(id)

            override fun onDeleteClick(id: Int) = mViewModel.delete(id)
